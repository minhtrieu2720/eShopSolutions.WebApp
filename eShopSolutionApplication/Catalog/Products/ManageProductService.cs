...
using eShopSolutions.Utilities.Exceptions;
using System;
...
namespace eShopSolutions.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public Task<int> AddImage(int productId, ProductImageViewModel productImage)
        {
        ...
        public async Task<PagedViewModel<ProductViewModel>> GetAllPaging(GetManageProductPagingRequest request)
        {
            ...
            var paged = new PagedViewModel<ProductViewModel>()
            {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new EShopExceptions($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new EShopExceptions($"Cannot find a product with id: {productId}");
