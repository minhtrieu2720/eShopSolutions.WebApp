...
using eShopSolutions.Data.Enum;
    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            var roleId = new Guid("09C6650E-E546-47A8-83C9-334288CBF890");
            var adminId = new Guid("8FF90397-F7D3-4F97-8EFE-D563682F7C29");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "nguyenminhtrieu201198@gmail.com",
                NormalizedEmail = "nguyenminhtrieu201198@gmail.com",
                EmailConfirmed = true,
